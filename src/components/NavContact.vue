<template>
    <nav class="flex nav secondary">
        ...
        <div class="absolute top-0 right-0 p-6 mt-10 bg-white shadow-lg md:mt-0 rounded-bl-md md:shadow-none md:bg-transparent md:p-0" v-if="isVisible" >
            <strong class="block w-full mb-2 text-sm uppercase md:mt-6 external">Social</strong>
