<template>
    <nav class="flex nav secondary">
        ...
        <div class="relative z-50 social-links">
            ...
            <div class="absolute top-0 right-0 p-6 mt-10 bg-white shadow-lg md:top-auto md:mt-0 rounded-bl-md md:shadow-none md:bg-transparent md:p-0" v-if="isVisible" >
