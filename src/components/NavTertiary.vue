<template>
    <nav class="flex flex-row items-center mb-5 text-white sm:flex-col nav tertiary">
        ...
        <a href="#" class="sm:mt-4 toggle" tooltip="Switch Theme" role="button" aria-label="Toggle dark/light" @click.prevent="toggleTheme">
        ...
        <g-link class="search sm:mt-4" tooltip="Search" to="/search" aria-label="Search the SmokeyFro site">
