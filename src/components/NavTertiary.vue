<template>
    <nav class="flex flex-row items-center mb-5 text-white sm:flex-col nav tertiary">
        <!-- <a href="/contact" class="connect" tooltip="Connect" aria-label="Connect via your favorite social media outlet">
         ...
         <a href="#" class="\toggle" tooltip="Switch Theme" role="button" aria-label="Toggle dark/light" @click.prevent="toggleTheme">
            <span class="icon" v-if="darkTheme"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sun"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg></span>
        ...
        <g-link class="search" tooltip="Search" to="/search" aria-label="Search the SmokeyFro site">
            <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" viewBox="0 0 24 24">
                <defs/>
