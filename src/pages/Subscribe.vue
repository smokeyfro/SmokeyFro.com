	...
	<Layout :sidebar="false" :top="true" :bottom="false">
		<template slot="top-shelf">
            <div class="w-full h-screen md:flex md:items-center md:justify-center">
                <div class="mx-6 md:border md:border-gray-300 md:rounded-md md:shadow-lg md:px-12 md:py-12 md:bg-white md:w-1/2 subscribe-wrap">
                    <h1 class="mt-0 mb-6">Join my inner circle</h1>
                    <p class="text-xl">Get notified when I post new themes, tutorials and journal updates. Pick and choose what you get notified about. Once a month digest on your selected topics.</p>
